package br.com.qeep.moving.alunos.api.controller;
...
import br.com.qeep.moving.alunos.api.entity.Aluno;
import br.com.qeep.moving.alunos.api.entity.Teste;
import br.com.qeep.moving.alunos.api.repository.AlunoRepository;
...
public class AlunoController {
	...
	public Teste removeAluno(@PathVariable Long matricula) {
		repository.deleteById(matricula);
		return new Teste("Teste de valor", "Outro Teste de Valor");
	}
}